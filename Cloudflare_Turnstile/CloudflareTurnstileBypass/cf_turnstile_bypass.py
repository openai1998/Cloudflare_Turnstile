...
class TurnstileSolver:
    ...
    def _init_browser_options(self, user_agent: str, headless: bool = True) -> ChromiumOptions:
        """初始化浏览器选项"""
        options = (
            ChromiumOptions()
            .auto_port()
    ...
    async def _solve_internal(self, url: str, user_agent: str) -> Dict[str, str]:
        ...
        try:
            options = self._init_browser_options(user_agent, headless=self.config.headless)
